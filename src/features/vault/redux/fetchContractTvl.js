...
import { VAULT_FETCH_CONTRACT_TVL_BEGIN, VAULT_FETCH_CONTRACT_TVL_SUCCESS, VAULT_FETCH_CONTRACT_TVL_FAILURE } from './constants';
...
export function fetchContractApy() {
  return dispatch => {
    ...
    dispatch({
      type: VAULT_FETCH_CONTRACT_TVL_BEGIN,
    });
    ...
    const promise = new Promise((resolve, reject) => {
      ...
      doRequest.then(
        res => {
          dispatch({
            type: VAULT_FETCH_CONTRACT_TVL_SUCCESS,
            data: res.data,
          });
          resolve(res);
        },
        ...
        err => {
          dispatch({
            type: VAULT_FETCH_CONTRACT_TVL_FAILURE,
            data: { error: err },
          });
          reject(err);
        }
...
export function useFetchContractTvl() {
...
export function reducer(state, action) {
  switch (action.type) {
    case VAULT_FETCH_CONTRACT_TVL_BEGIN:
    ...
    case VAULT_FETCH_CONTRACT_TVL_SUCCESS:
    ...
    case VAULT_FETCH_CONTRACT_TVL_FAILURE:
