...
export const VAULT_FETCH_ORACLE_PRICES_BEGIN = 'VAULT_FETCH_ORACLE_PRICES_BEGIN';
export const VAULT_FETCH_ORACLE_PRICES_SUCCESS = 'VAULT_FETCH_ORACLE_PRICES_SUCCESS';
export const VAULT_FETCH_ORACLE_PRICES_FAILURE = 'VAULT_FETCH_ORACLE_PRICES_FAILURE';
...
export const VAULT_FETCH_PRICE_PER_SHARE_BEGIN = 'VAULT_FETCH_PRICE_PER_SHARE_BEGIN';
export const VAULT_FETCH_PRICE_PER_SHARE_SUCCESS = 'VAULT_FETCH_PRICE_PER_SHARE_SUCCESS';
export const VAULT_FETCH_PRICE_PER_SHARE_FAILURE = 'VAULT_FETCH_PRICE_PER_SHARE_FAILURE';
