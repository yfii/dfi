...
const fetchPancake = async () => {
  try {
    const response = await axios.get(`https://api.beefy.finance/pancake/price?_=1616031817`);
...
const fetchLP = async () => {
  try {
    const response = await axios.get(`https://api.beefy.finance/lps?_=1616031817`);
    return response.data;
  } catch (err) {
    console.error(err);
    return {};
...
const fetchBakery = async () => {
  try {
    const response = await axios.get(`https://api.beefy.finance/bakery/price?_=1616031817`);
    return response.data;
  } catch (err) {
    console.error(err);
    return {};
