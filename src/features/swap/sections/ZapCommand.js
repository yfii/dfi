  ...
  const onFetchZapOrSwap = () => {
    fetchZapOrSwap(
      ...
      new BigNumber(sendJson.num)
        .multipliedBy(new BigNumber(10).exponentiatedBy(tokens[showIndex].decimals))
        .toString(10)
    );
  };
      ...
      <div className={classes.zapContainer}>
        ...
        <div className={classes.boxContainer}>
          <div className={classes.boxHeader}>
            ...
            <div className={classes.boxHeaderSub}>{`${t('Swap-Balance')}: ${balanceTotal.toFormat(
              tokens[showIndex].decimals
            )} ${tokens[showIndex].name}`}</div>
          </div>
